...
def evaluate():
    ...
    df_count = pd.merge(accelerometers[['tsm_id','accel_id','node_id','in_use']], df_count, how = 'inner', on = 'accel_id')
    ...
    df_count['recommendation'][df_count.good_ortho == 0] = 'tag as not ok - invalid magnitude'
    df_count['recommendation'][df_count.good_range == 0] = 'tag as not ok - out of range'
